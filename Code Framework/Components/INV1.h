...
public:
	...
	INV1(GraphicsInfo *r_pGfxInfo, int r_FanOut);
	...
	virtual bool IsInRegion(int x, int y); //Checks whether the clicked point is in the region of the INV gate or not
